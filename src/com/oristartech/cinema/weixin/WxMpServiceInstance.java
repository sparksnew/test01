...
public class WxMpServiceInstance {
	...
	private void addTestRouter() {
		WxMpMessageHandler handler = new WxMpMessageHandler() {
			public WxMpXmlOutMessage handle(WxMpXmlMessage wxMessage, Map<String, Object> context,
				...
				WxMpXmlOutTextMessage m = WxMpXmlOutMessage.TEXT().content("成功收到测试指令")
	...
	private void buildMenu() {
		...
		takeout.setUrl(
				"https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + this.getWxMpConfigStorage().getAppId()
	...
	private void addMenuRouter() {
		WxMpMessageHandler handler = new WxMpMessageHandler() {
			public WxMpXmlOutMessage handle(WxMpXmlMessage wxMessage, Map<String, Object> context,
				...
				buildMenu();
				WxMpXmlOutTextMessage m = WxMpXmlOutMessage.TEXT().content("菜单已重构").fromUser(wxMessage.getToUserName())
